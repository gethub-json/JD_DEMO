...
import com.jd.lie.mine.picker.engine.LoadEngine;
...
public final class Picker {
    ...
    public void forResult(int requestCode) {
        ...
        mSelectionSpec.setSelect_count(mResumeList.size());
...
//        intent.putExtra(ImageSelectActivity.EXTRA_ENGINE, (Serializable) engine);
    ...
    public void forFragmentResult(int requestCode, Context context) {
        if (engine == null)
            throw new ExceptionInInitializerError(LoadEngine.INITIALIZE_ENGINE_ERROR);
