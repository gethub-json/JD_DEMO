...
/**
 * @author ：王文彬 on 2020-01-16 16：49
 * @describe ：
...
public class DeviceUtils {
  ...
  private static final Pattern PATTERN = Pattern.compile("(\\d+\\.){2}\\d");
  ...
  private static boolean tablet(Context context) {
  ...
  public static boolean isFlymeVersionHigher5_2_4() {
    ...
    if (sFlymeVersionName != null && !sFlymeVersionName.isEmpty()) {
