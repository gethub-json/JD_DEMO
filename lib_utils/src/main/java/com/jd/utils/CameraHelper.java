...
public class CameraHelper {
  ...
  public static File getOutputMediaFile(String fileName, int type) {
    ...
    //原先存储的路径是  BuildConfig.APPLICATION_ID
    //File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(
    //        Environment.DIRECTORY_PICTURES), VIDEO_STORAGE_PATH);

    File mediaStorageDir = new File(Environment.getExternalStorageDirectory(), VIDEO_STORAGE_PATH);
