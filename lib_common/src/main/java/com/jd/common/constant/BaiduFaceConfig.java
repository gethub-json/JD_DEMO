...
public class BaiduFaceConfig {
  ...
  public static String apiKey = "xmZuZ7wbgMWx1bj5unXZ1TUE";
  public static String secretKey = "HxAazHqgp0lL9aZ4h8qXTZUT7AAMEvZE";
  public static String licenseID = "android-liecomputing-face-android";
  ...
  public static String groupID = "android-face";
